...
module.exports = {
    ...
    async checkForPythonInstall() {
        const {installed} = await this.checkForDependency('Python 3.6.+', 'pip3 --version', 'brew update && brew install python3', true, async e => {
        ...
        // TODO : Check the python version with semver and pull out major/minor and use those values instead of hard coding 3.6
        if (installed) {
            try {
                ...
                logUtil.warn('Python 3.6 has been added to your path. Please restart your terminal session and rerun.');
                process.exit();
            }
        }
        return installed;
